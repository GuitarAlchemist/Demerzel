...
baml_function_async!(EvaluateSignalSwarm(telemetry: &types::SignalTelemetry, role: &types::AgentRole, bounds: &types::SafetyBounds, ) -> (stream_types::SwarmVote, types::SwarmVote));
...
pub struct BamlAsyncClient {
    ...
    pub EvaluateSignalSwarm: EvaluateSignalSwarm,
...
impl BamlAsyncClient {
    pub const fn new() -> Self {
        Self {
            ...
            EvaluateSignalSwarm: EvaluateSignalSwarm::new(),
    ...
    pub fn with_options(&self, options: FunctionOptions) -> Self {
        Self {
            ...
            EvaluateSignalSwarm: EvaluateSignalSwarm { options: options.clone() },
