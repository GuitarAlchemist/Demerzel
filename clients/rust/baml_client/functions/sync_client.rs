...
baml_function_sync!(EvaluateSignalSwarm(telemetry: &types::SignalTelemetry, role: &types::AgentRole, bounds: &types::SafetyBounds, ) -> (stream_types::SwarmVote, types::SwarmVote));
