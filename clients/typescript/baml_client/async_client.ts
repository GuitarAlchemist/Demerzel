...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        async EvaluateSignalSwarm(
        telemetry: types.SignalTelemetry,role: types.AgentRole,bounds: types.SafetyBounds,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.SwarmVote> {
          try {
          ...
          const __stream__ = this.stream.EvaluateSignalSwarm(
          telemetry,role,bounds,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.SwarmVote
            } catch (error) {
            ...
            telemetry: types.SignalTelemetry,role: types.AgentRole,bounds: types.SafetyBounds,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.SwarmVote, types.SwarmVote>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for EvaluateSignalSwarm", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.SwarmVote, types.SwarmVote>(
                  __raw__,
                  (a): partial_types.SwarmVote => a,
                  (a): types.SwarmVote => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
