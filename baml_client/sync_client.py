...
class BamlSyncClient:
    ...
    def EvaluateSignalSwarm(self, telemetry: types.SignalTelemetry,role: types.AgentRole,bounds: types.SafetyBounds,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="EvaluateSignalSwarm", args={
...
class BamlStreamClient:
    ...
    def EvaluateSignalSwarm(self, telemetry: types.SignalTelemetry,role: types.AgentRole,bounds: types.SafetyBounds,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.SwarmVote, types.SwarmVote]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="EvaluateSignalSwarm", args={
            "telemetry": telemetry,"role": role,"bounds": bounds,
        })
        return baml_py.BamlSyncStream[stream_types.SwarmVote, types.SwarmVote](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def EvaluateSignalSwarm(self, telemetry: types.SignalTelemetry,role: types.AgentRole,bounds: types.SafetyBounds,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="EvaluateSignalSwarm", args={
            "telemetry": telemetry,"role": role,"bounds": bounds,
        }, mode="request")
        return __result__
