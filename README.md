...
| GitHub workflows | 31 | `.github/workflows/*.yml` |
...
31 GitHub workflows under [`.github/workflows/`](./.github/workflows/). Notable:
...
- [`registry-check-build.yml`](./.github/workflows/registry-check-build.yml) — builds the registry checker from a PR that changes its pinned build inputs.
