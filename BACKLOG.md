...
|---|---:|---|
| `python_test_modules` | 43 | `scripts/test_*.py` modules |
| `python_root_recomputations` | 41 | Executable repo-root recomputations outside `demerzel_kit.ROOT` |
...
| `workflow_agent_blackbox_steps` | 9 | Steps in `.github/workflows/agent-blackbox.yml` |
