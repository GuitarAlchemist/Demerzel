...
|---|---:|---|
| `python_test_modules` | 38 | `scripts/test_*.py` modules |
| `python_root_recomputations` | 36 | Executable repo-root recomputations outside `demerzel_kit.ROOT` |
| `planner_collision_detector_non_test_refs` | 2 | Matching lines for `planner_collision_detector` outside tests and its definition |
